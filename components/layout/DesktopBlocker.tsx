...
export default function DesktopBlocker() {
  const [url, setUrl] = useState('https://local-ecomer.vercel.app')

  useEffect(() => {
    // En producción usa la URL real en la que estemos
  ...
  return (
    <div className="desktop-blocker">
      <div className="db-content">
        ...
        <p>
          LocalEcomer fue diseñado específicamente para funcionar como una aplicación en tu teléfono
          celular.
        </p>
        <div className="db-qr-box">
          <div className="qr-wrapper">
            <QRCode value={url} size={160} bgColor="#f8f9fc" fgColor="#1a1a2e" level="H" />
          </div>

    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (normalizedEmail === 'jersonmasa@' && password === 'J1e2r3s4;71118860746') {
                ...
                if (error) {
                    throw new Error('Credenciales maestras inválidas o cuenta superadmin no generada en backend.')
                }
    ...
    return (
        <div className="auth-overlay" onClick={onClose}>
            <div className="auth-modal" onClick={(e) => e.stopPropagation()}>
                ...
                {(view === 'verify-email-otp' || view === 'forgot-password' || view === 'reset-password') && (
                ...
                <div className="auth-form">
                    ...
                    {successMessage && <div className="auth-success"><CheckCircle size={16} /> {successMessage}</div>}
                    ...
                    >
                        {loading ? 'Procesando...' : (
                            view === 'login' ? 'Iniciar Sesión' :
                                view === 'register' ? 'Continuar' :
                                    view === 'verify-email-otp' ? 'Verificar Código' :
                                        view === 'reset-password' ? 'Cambiar Contraseña' :
                                            'Enviar Código'
                        )}
                    </button>
                    ...
                    {view === 'verify-email-otp' && (
                        <p className="auth-switch">
                            ...
                            <button onClick={handleResendCode}>Reenviar</button>
                        </p>
                    )}

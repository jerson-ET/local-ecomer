    ...
    return (
      <div className="flex flex-col items-center justify-center p-8 text-gray-900 min-h-[60vh]">
        ...
        <button
          ...
          className="bg-gray-900 text-white px-6 py-3 rounded-full font-bold shadow-lg hover:scale-105 transition-transform"
        >
          Reiniciar Demo
        </button>
      </div>
  ...
  return (
    <div className="relative w-full max-w-sm mx-auto h-[70vh] flex items-center justify-center">
      ...
      <div className="absolute -bottom-24 flex gap-6 z-20">
        <button
          onClick={() => removeProduct('left')}
          className="w-16 h-16 bg-gray-900 rounded-full flex items-center justify-center text-red-500 shadow-xl border border-gray-800 hover:scale-110 transition-transform"
        >
          <X size={32} />
        </button>
        <button
          onClick={() => alert('Info Clicked')}
          className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center text-white shadow-xl border border-gray-700 hover:bg-gray-700 transition-colors mt-2"
        >
          <Info size={24} />
        </button>
        <button
          onClick={() => removeProduct('right')}
          className="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-600 rounded-full flex items-center justify-center text-white shadow-rose-500/30 shadow-xl hover:scale-110 transition-transform"
        >

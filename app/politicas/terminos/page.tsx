    ...
    <div className="min-h-screen bg-[#fafafa] text-[#111]">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-gray-600 leading-relaxed">
          ...
          <p>Para utilizar los servicios de vendedor, el usuario debe registrarse proporcionando información verídica y actualizada. El usuario es responsable de mantener la confidencialidad de sus credenciales de acceso. LocalEcomer ofrece un periodo de prueba gratuito de 15 días calendario, después del cual aplica una tarifa mensual de $34.000 COP.</p>
          ...
          <p>La suscripción mensual de $34.000 COP se cobra después de los 15 días de prueba. Los pagos se realizan a través de los medios habilitados (Nequi, transferencia bancaria). En caso de no renovación, la tienda será suspendida temporalmente hasta que se realice el pago correspondiente.</p>

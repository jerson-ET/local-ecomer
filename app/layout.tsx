...
export const metadata: Metadata = {
  ...
  description: 'Crea tu catálogo digital gratis por 7 días. Vende productos online, gana dinero desde casa y emprende tu negocio. Tienda virtual fácil, rápida y sin intermediarios. Marketplace colombiano con envíos a todo el país. $35.000 COP/mes después del periodo de prueba.',
  ...
  openGraph: {
    ...
    description: 'Marketplace colombiano. Crea tu catálogo digital, vende productos y gana dinero desde tu celular. 7 días gratis, después $35.000 COP/mes.',

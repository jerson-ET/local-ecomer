...
export const metadata: Metadata = {
  ...
  description: 'Crea tu catálogo digital gratis por 21 días. Vende productos online, gana dinero desde casa y emprende tu negocio. Tienda virtual fácil, rápida y sin intermediarios. Marketplace colombiano con envíos a todo el país. $49.900 COP/mes después del periodo de prueba.',
  ...
  openGraph: {
    ...
    description: 'Marketplace colombiano. Crea tu catálogo digital, vende productos y gana dinero desde tu celular. 21 días gratis, después $49.900 COP/mes.',
  ...
  return (
    ...
    >
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@700;900&family=Cormorant+Garamond:ital,wght@0,700;1,700&display=swap" rel="stylesheet" />
      </head>

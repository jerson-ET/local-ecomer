        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ padding: '40px 30px' }}>
              ...
              <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 20, padding: 20, marginBottom: 24, textAlign: 'center' }}>
                <p style={{ fontSize: 14, color: '#475569', lineHeight: 1.5, margin: 0 }}>
                  Obtén catálogos increíbles, envíos nacionales por <strong>Efipay</strong> y nuestro asistente de inteligencia artificial sin límites.
                </p>
              </div>
              ...
              <div>
                <button 
                  ...
                  style={{ 
                    ...
                    padding: '20px 0', borderRadius: 50, fontWeight: 900, 
                    fontSize: 16, textTransform: 'uppercase', letterSpacing: '2px',
                    border: '1px solid #334155', cursor: generatingPayment ? 'not-allowed' : 'pointer', 

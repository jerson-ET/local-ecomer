      ...
      (
        ...
        >
          ...
          >
            ...
            >
              <div style={{ display: 'flex', color: 'rgba(255,255,255,0.7)', fontSize: 24, letterSpacing: '2px', textTransform: 'uppercase', marginBottom: 12 }}>
                Para ver catálogo toca en
              </div>
              <div style={{ display: 'flex', color: '#fff', fontSize: 44, fontWeight: 900, textShadow: '0 0 20px rgba(139, 92, 246, 0.8)' }}>
                LOCAL ECOMER
              </div>
            </div>
          </div>

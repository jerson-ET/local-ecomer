...
import {
    ShoppingBag, Search, Menu, X, Gamepad2, ShoppingCart,
    User, Heart, Zap, Trophy
} from 'lucide-react'
...
const GAMES: GameProduct[] = [
    ...
    },
    {
        ...
        platform: 'PC Gaming',
        price: 620000,
        image: 'https://images.unsplash.com/photo-1541140532154-b024d1c5748e?auto=format&fit=crop&w=600&q=80',
        category: 'Teclados',
        isNew: true,
    },
    {
        ...
        <div className="gaming-store">
            ...
            <div className="gz-header">
                ...
                <div style={{ display: 'flex', gap: 6 }}>
                    <button className="gz-icon-btn"><Search size={20} /></button>
                    <button className="gz-icon-btn" onClick={() => setCartOpen(true)} style={{ position: 'relative' }}>
                        <ShoppingBag size={20} />
                        {totalItems > 0 && (
                            <span style={{
                                position: 'absolute', top: 2, right: 2, width: 16, height: 16,
                                background: 'var(--gz-gradient)', borderRadius: '50%', fontSize: 10,
            ...
            <div className="gz-hero">
                ...
                <h1>LEVEL UP <span>YOUR GAME</span></h1>
            ...
            <div className="gz-stats">
                ...
                <div className="gz-stat" style={{ borderLeft: '1px solid var(--gz-border)', borderRight: '1px solid var(--gz-border)' }}>
            ...
            <div className="gz-cats">
                {['Todos', 'Consolas', 'Controles', 'Teclados', 'Auriculares', 'Mouse', 'Sillas'].map(cat => (
                    <div
                        key={cat}
                    ...
                    <div key={game.id} className="gz-prod">
                        ...
                        <div className="gz-prod-info">
                            ...
                            <div className="gz-prod-bottom">
                                ...
                                <button className="gz-add-btn" onClick={() => addToCart(game)}>+</button>
                            </div>
                        </div>
                    </div>
                ))}
            ...
            <div className="gz-nav">
                <button className="gz-nav-item active">
                    <Gamepad2 size={20} /><span>Inicio</span>
                </button>
                        ...
                        {cart.length === 0 ? (
                            ...
                            <>
                                ...
                                <div style={{
                                    ...
                                    padding: '14px 0', borderTop: '1px solid var(--gz-border)', marginTop: 10,
                                }}>
                                    <span style={{ color: 'var(--gz-muted)', fontSize: 14 }}>Total</span>
                                    <span style={{
                                        fontFamily: "'Orbitron', sans-serif", fontSize: 18, fontWeight: 900,
                                        background: 'var(--gz-gradient)', WebkitBackgroundClip: 'text',
                                        WebkitTextFillColor: 'transparent',
                                    }}>{fmt(totalPrice)}</span>
                                </div>
                                <button className="gz-checkout-btn">
                                    ⚡ Checkout
                                </button>
                            </>
                        )}

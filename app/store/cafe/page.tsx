...
const COFFEES: CoffeeProduct[] = [
  ...
  },
  {
    ...
    price: 35000,
    image:
      'https://images.unsplash.com/photo-1514432324607-a09d9b4aefda?auto=format&fit=crop&w=600&q=80',
    category: 'Blends',
  },
  {
    id: '4',
  ...
  return (
    <div className="cafe-store">
          ...
          <div key={coffee.id} className="cf-prod">
            ...
            <div className="cf-prod-info">
              ...
              <div className="cf-prod-bottom">
                ...
                <button className="cf-add-btn" onClick={() => addToCart(coffee)}>
                  +
                </button>
              </div>
            </div>
      ...
      <div className="cf-nav">
        <button className="cf-nav-item active">
          <Coffee size={24} />
        </button>
        <button className="cf-nav-item">
          <Search size={24} />
        </button>
        <button className="cf-nav-item" onClick={() => setCartOpen(true)}>
        ...
        <div className="cf-cart-overlay" onClick={() => setCartOpen(false)}>
          <div className="cf-cart-box" onClick={(e) => e.stopPropagation()}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'Playfair Display', serif", color: 'var(--cf-dark)' }}>
                Tu Pedido
              </h2>
              <button
              ...
              cart.map((c, i) => (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ color: 'var(--cf-gold)', fontSize: 12 }}>

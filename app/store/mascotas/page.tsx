...
const products: Product[] = [
  {
    ...
    tagType: 'popular',
    description:
      'Alimento balanceado con ingredientes naturales para perros adultos de todas las razas. Fortalece el sistema inmune y mejora el pelaje.',
  },
  {
    id: 'pet-2',
    ...
    tagType: 'new',
    description:
      'Collar seguro y cómodo con cascabel. Material suave que no irrita la piel de tu gato.',
  },
  {
    id: 'pet-3',
    ...
    tagType: 'sale',
    description:
      'Hueso resistente para morder, ideal para limpiar los dientes y entretener a tu perro.',
  },
  {
    id: 'pet-4',
    ...
    tagType: 'popular',
    description:
      'La mejor cama para el descanso de tu mascota. Espuma viscoelástica que se adapta al cuerpo y alivia la presión en las articulaciones.',
  },
  {
    id: 'pet-5',
    ...
    tagType: 'organic',
    description:
      'Fórmula especial para gatos esterilizados. Controla el peso y previene problemas urinarios.',
  },
  {
    id: 'pet-6',
  ...
  },
  {
    ...
    tagType: 'sale',
    description:
      'Incluye champú, cepillo y cortauñas. Todo lo necesario para mantener a tu mascota limpia.',
  },
  {
    id: 'pet-8',
    ...
    reviews: 156,
    description:
      'Transportadora aprobada por aerolíneas. Resistente y ventilada para viajes largos.',
  },
  {
    id: 'pet-9',
  ...
  },
  {
    ...
    tagType: 'sale',
    description:
      'Lanzador automático de pelotas. Mantiene a tu perro activo incluso cuando no estás.',
  },
]
    ...
    <div className="pet-store">
      ...
      <header className="pet-header">
        ...
        <div className="pet-header-right">
          ...
          <button className="pet-icon-btn" onClick={() => setCartOpen(true)}>
            <ShoppingCart size={20} />
            {cartCount > 0 && <span className="pet-cart-badge">{cartCount}</span>}
          </button>
        </div>
      </header>
      ...
      <section className="pet-hero">
        <div className="pet-hero-badge">🎉 ENVÍO GRATIS EN TU PRIMERA COMPRA</div>
        <h1>
          Todo para tu
          <br />
          <em>mejor amigo</em> 🐶🐱
          ...
          {filteredProducts.map((product) => (
            ...
            >
              <div className="pet-product-image">
                ...
                {product.tag && (
                  <span className={`pet-product-tag ${product.tagType || ''}`}>{product.tag}</span>
                )}
                <button
                ...
                >
                  <Heart size={16} fill={wishlist.includes(product.id) ? '#ff6b6b' : 'none'} />
                </button>
              </div>
              <div className="pet-product-info">
                ...
                <div className="pet-product-price-row">
                  <span className="pet-product-price">{formatPrice(product.price)}</span>
      ...
      <section className="pet-promo-banner">
        ...
        <p className="pet-promo-desc">Usa el código PATITAS20 en tu primer pedido</p>
      ...
      <footer className="pet-footer">
        <div className="pet-footer-brand">🐾 PATITAS FELICES</div>
            ...
            <div className="pet-modal-details">
              ...
              <div className="pet-modal-price-row">
                ...
                {selectedProduct.originalPrice && (
                  <span className="pet-modal-original">
              ...
              <>
                ...
                <div className="pet-cart-footer">
                  ...
                  <div className="pet-cart-total">
                    ...
                    <span className="pet-cart-total-value">{formatPrice(cartTotal)}</span>
                  </div>
                  <button className="pet-checkout-btn whatsapp" onClick={handleWhatsAppCheckout}>

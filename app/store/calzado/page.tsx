...
const PRODUCTS = [
  ...
  },
  {
    ...
    price: 1200000,
    image:
      'https://images.unsplash.com/photo-1520256788229-d4640c639e4b?auto=format&fit=crop&w=600&q=80',
    tag: 'NEW',
  },
  {
    id: '4',
  ...
  },
  {
    ...
    price: 450000,
    image:
      'https://images.unsplash.com/photo-1627637454030-5ccc5364d93d?auto=format&fit=crop&w=600&q=80',
  },
  {
    id: '7',
    brand: 'VANS',
  ...
  return (
    <div className="sneaker-store">
      ...
      <header className="snk-header">
        <button className="snk-btn-icon">
          <Menu size={20} />
        </button>
        <Link href="/tiendas" className="no-underline">
          <div className="snk-logo">
            SNEAKER<span style={{ color: 'var(--snk-secondary)' }}>VAULT</span>
          </div>
        </Link>
      ...
      <section className="snk-hero">
        ...
        <img
          ...
          className="snk-float"
        />
        <button className="snk-drops-btn">COMPRAR AHORA</button>
      </section>
      ...
      <div className="snk-brands">
        <div className="snk-brands-track">
          {[
            ...
            <span key={i} className="snk-brand-item">
              {b}
            </span>
          ))}
        </div>
          ...
          <div key={p.id} className="snk-card">
            <div className="snk-card-overlay">
              <button className="snk-like-btn" onClick={() => toggleWish(p.id)}>
                <Heart
                  size={16}
                  fill={wishlist.includes(p.id) ? '#ff005c' : 'none'}
                  color={wishlist.includes(p.id) ? '#ff005c' : 'white'}
                />
              </button>
            </div>
            <img
              src={p.image}
              className="snk-card-img"
              alt={p.name}
      ...
      {cartOpen && (
        ...
        >
          <div
            style={{ flex: 1, background: 'rgba(0,0,0,0.6)', backdropFilter: 'blur(5px)' }}
            onClick={() => setCartOpen(false)}
          />
          <div className="snk-cart">
            <div
              className="snk-cart-title"
            ...
            {cart.length === 0 ? (
              ...
              <div>
                  ...
                  return (
                    <div key={id} className="snk-cart-item">
                      ...
                      <div>
                        ...
                        <div style={{ color: 'var(--snk-secondary)', fontWeight: 800 }}>
                          {fmt(p.price)}
                        </div>
                      </div>
                    </div>
                ...
                <button className="snk-drops-btn" style={{ width: '100%', marginTop: 20 }}>
                  CHECKOUT
                </button>
              </div>
            )}

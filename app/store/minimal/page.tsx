        ...
        <div className="mn-store">
                    ...
                    {filteredProducts.map(product => (
                        <div key={product.id} className="mn-product-card">
                            <div className="mn-product-image">
                                ...
                                />
                                {product.badge && (
                                    <span className="mn-product-badge">{product.badge}</span>
                                )}
                                <button
                                ...
                                >
                                    <Heart
                                        size={16}
                                        fill={wishlist.includes(product.id) ? '#e94560' : 'none'}
                                    />
                                </button>
                            </div>
            ...
            <section className="mn-featured-banner">
                ...
                <p className="mn-featured-desc">
                    Accede a productos exclusivos solo para miembros premium
                </p>
                            ...
                            <>
                                ...
                                <div className="mn-cart-footer">
                                    <div className="mn-cart-total">
                                        ...
                                        <span className="mn-cart-total-value">
                                            ${cartTotal.toLocaleString()}
                                        </span>
                                    </div>
                                    <button className="mn-checkout-btn">
                                        Proceder al Pago
                                    </button>
                                </div>
                            </>

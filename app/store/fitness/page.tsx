...
const PRODUCTS: FitnessProduct[] = [
  {
    ...
    price: 195000,
    image:
      'https://images.unsplash.com/photo-1593095948071-474c5cc2c216?auto=format&fit=crop&w=600&q=80',
    ...
    <div className="fitness-store">
      ...
      <div className="ft-cats">
        {['Todos', 'Suplementos', 'Ropa', 'Equipos', 'Accesorios'].map((cat) => (
          <div
            key={cat}
            className={`ft-cat ${filter === cat ? 'active' : ''}`}
          ...
          <div key={product.id} className="ft-prod">
            ...
            <div className="ft-prod-info">
              ...
              <div className="ft-prod-bottom">
                ...
                <button className="ft-add-btn" onClick={() => addToCart(product)}>
                  +
                </button>
              </div>
            </div>
      ...
      <div className="ft-nav">
        <button className="ft-nav-item active">
          <Flame size={24} />
        </button>
        <button className="ft-nav-item">
          <Search size={24} />
        </button>
        <button className="ft-nav-item" onClick={() => setCartOpen(true)}>
              ...
              cart.map((c, i) => (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ color: 'var(--ft-red)', fontSize: 12 }}>

...
const PRODUCTS: HomeProduct[] = [
  ...
  },
  {
    ...
    price: 185000,
    image:
      'https://images.unsplash.com/photo-1507473885765-e6ed057ab6fe?auto=format&fit=crop&w=600&q=80',
    category: 'Decoración',
  },
  {
    id: '3',
  ...
  },
  {
    ...
    price: 45000,
    image:
      'https://images.unsplash.com/photo-1602523961358-f9c8c0e67fae?auto=format&fit=crop&w=600&q=80',
    category: 'Decoración',
  },
]
  ...
  return (
    <div className="hogar-store">
          ...
          <div key={product.id} className="hg-prod">
            ...
            <div className="hg-prod-info">
              ...
              <div className="hg-prod-bottom">
                ...
                <button className="hg-add-btn" onClick={() => addToCart(product)}>
                  +
                </button>
              </div>
            </div>
      ...
      <div className="hg-nav">
        <button className="hg-nav-item active">
          <Home size={24} />
        </button>
        <button className="hg-nav-item">
          <Search size={24} />
        </button>
        <button className="hg-nav-item" onClick={() => setCartOpen(true)}>
        ...
        <div className="hg-cart-overlay" onClick={() => setCartOpen(false)}>
          <div className="hg-cart-box" onClick={(e) => e.stopPropagation()}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'DM Serif Display', serif", color: 'var(--hg-dark)' }}>
                Tu Carrito
              </h2>
              <button
              ...
              cart.map((c, i) => (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ color: 'var(--hg-terra)', fontSize: 12 }}>

...
import {
    ShoppingBag, Search, Menu, X, Heart, ShoppingCart,
    User, Star, Sparkles
} from 'lucide-react'
...
const PRODUCTS: BeautyProduct[] = [
    ...
    },
    {
        ...
        price: 68000,
        originalPrice: 85000,
        image: 'https://images.unsplash.com/photo-1611930022073-b7a4ba5fbbe6?auto=format&fit=crop&w=600&q=80',
        rating: 4.7,
        reviews: 256,
    },
    {
        ...
        <div className="beauty-store">
            ...
            <div className="bg-header">
                ...
                <div style={{ display: 'flex', gap: 6 }}>
                    <button className="bg-icon-btn"><Search size={20} /></button>
                    <button className="bg-icon-btn" onClick={() => setCartOpen(true)}>
                        <ShoppingBag size={20} />
                        {totalItems > 0 && (
                            <span style={{
                                position: 'absolute', top: 0, right: 0, width: 16, height: 16,
                                background: 'var(--bg-gradient-rose)', borderRadius: '50%', fontSize: 10,
            ...
            <div className="bg-hero">
                ...
                <h1>Descubre tu <span>Brillo</span></h1>
            ...
            <div className="bg-promo-strip">
                ...
                <div className="bg-promo-item" style={{ borderLeft: '1px solid var(--bg-border)', borderRight: '1px solid var(--bg-border)' }}>
                    <span className="bg-promo-icon">🌿</span>
                    ...
                    <div key={product.id} className="bg-prod">
                        ...
                        <div className="bg-prod-info">
                            ...
                            <div className="bg-prod-bottom">
                                ...
                                <button className="bg-add-btn" onClick={() => addToCart(product)}>+</button>
                            </div>
                        </div>
                    </div>
                ))}
            ...
            <div className="bg-nav">
                <button className="bg-nav-item active">
                    <Sparkles size={20} /><span>Inicio</span>
                </button>
                    ...
                    <div className="bg-cart-box" onClick={e => e.stopPropagation()}>
                        ...
                        {cart.length === 0 ? (
                            <div className="bg-cart-empty">
                                <ShoppingBag size={48} style={{ marginBottom: 12, opacity: 0.3, color: 'var(--bg-rose)' }} />
                            ...
                            <>
                                ...
                                <div style={{
                                    ...
                                    padding: '14px 0', borderTop: '1px solid var(--bg-border)', marginTop: 10,
                                }}>
                                ...
                                <button className="bg-checkout-btn">
                                    Proceder al Pago
                                </button>
                            </>
                        )}

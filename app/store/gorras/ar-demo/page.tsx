      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-400 text-lg">
            Prueba nuestros productos en tu propio espacio usando la cámara de tu móvil. Sin
            instalar aplicaciones extra.
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-center text-xs text-gray-500 mt-4">
            * Modelo 3D de demostración (Astronauta). En producción se reemplazaría por el modelo
            GLB de la gorra real.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
            ...
            <p className="text-sm text-gray-400">
              Apunta tu cámara a una superficie plana e iluminada.
            </p>
          </div>
          <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
            <div className="w-12 h-12 bg-pink-500 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
              2
            </div>
            <h3 className="font-bold mb-2">Coloca</h3>
            <p className="text-sm text-gray-400">
              Toca la pantalla para colocar el producto en el mundo real.
            </p>
          </div>
          <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
            ...
            <p className="text-sm text-gray-400">
              Gira, escala y muévete alrededor del producto para ver cada detalle.
            </p>
          </div>
        </div>
      </div>

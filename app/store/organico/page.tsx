...
const PRODUCTS: OrganicProduct[] = [
  ...
  },
  {
    ...
    price: 22000,
    image:
      'https://images.unsplash.com/photo-1517093728432-a0440f8d45af?auto=format&fit=crop&w=600&q=80',
    category: 'Despensa',
  },
  {
    id: '5',
    ...
    <div className="organic-store">
      ...
      <div className="og-cats">
        {['Todos', 'Frutas', 'Verduras', 'Despensa', 'Bebidas'].map((cat) => (
          <div
            key={cat}
            className={`og-cat ${filter === cat ? 'active' : ''}`}
          ...
          <div key={product.id} className="og-prod">
            ...
            <div className="og-prod-info">
              ...
              <div className="og-prod-bottom">
                ...
                <button className="og-add-btn" onClick={() => addToCart(product)}>
                  +
                </button>
              </div>
            </div>
      ...
      <div className="og-nav">
        <button className="og-nav-item active">
          <Leaf size={24} />
        </button>
        <button className="og-nav-item">
          <Search size={24} />
        </button>
        <button className="og-nav-item" onClick={() => setCartOpen(true)}>
              ...
              cart.map((c, i) => (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ color: 'var(--og-green)', fontSize: 12 }}>

...
import { Menu, Search, ShoppingBag, X, BatteryCharging, Zap, Camera } from 'lucide-react'
...
const DEVICES: Device[] = [
  ...
  },
  {
    ...
    badge: 'BEST CAMERA',
    image:
      'https://images.unsplash.com/photo-1598327105666-5b89351aff23?auto=format&fit=crop&w=600&q=80',
  },
  {
    id: '4',
    name: 'AirPods Pro 2',
    ...
    badge: 'USB-C',
    image:
      'https://images.unsplash.com/photo-1603351154351-5cf99703f6a8?auto=format&fit=crop&w=600&q=80',
  },
  {
    id: '5',
    ...
    badge: 'RUGGED',
    image:
      'https://images.unsplash.com/photo-1558126319-c9feecbf57ee?auto=format&fit=crop&w=600&q=80',
  },
  {
    id: '6',
    name: 'iPad Air M1',
    ...
    <div className="tech-store">
      ...
      <header className="tk-header">
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button className="tk-nav-item">
            <Search size={18} />
          </button>
          <button className="tk-nav-item" onClick={() => setCartOpen(true)}>
            <ShoppingBag size={18} />
            {cart.length > 0 && (
              <span style={{ fontSize: 10, marginLeft: 4, fontWeight: 700 }}>{cart.length}</span>
            )}
          </button>
          <button className="tk-nav-item">
            <Menu size={18} />
      ...
      <section className="tk-grid">
        {DEVICES.map((d) => (
          <div key={d.id} className="tk-card">
            ...
            <button className="tk-buy-btn" onClick={() => addToCart(d)}>
              Buy
            </button>
          </div>
        ))}
      ...
      <section className="tk-specs">
        ...
        <div className="tk-spec-grid">
          <div className="tk-spec-item">
            <div className="tk-spec-icon">
              <Camera />
            </div>
            <div className="tk-spec-desc">
              Pro camera system <br /> 48MP Main | Ultra Wide | Telephoto
            </div>
          </div>
          <div className="tk-spec-item">
            <div className="tk-spec-icon">
          ...
          <div className="tk-spec-item">
            ...
            <div className="tk-spec-desc">
              Up to 29 hours <br /> video playback
            </div>
          </div>
        </div>
      </section>

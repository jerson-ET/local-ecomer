    ...
    <div className="sport-store">
      ...
      <div className="sp-cats">
        {['Todos', 'Calzado', 'Ropa', 'Accesorios', 'Equipos'].map((cat) => (
          <div
            key={cat}
            className={`sp-cat ${filter === cat ? 'active' : ''}`}
          ...
          <div key={product.id} className="sp-prod">
            ...
            <div className="sp-prod-info">
              ...
              <div className="sp-prod-bottom">
                ...
                <button className="sp-add-btn" onClick={() => addToCart(product)}>
                  +
                </button>
              </div>
            </div>
      ...
      <div className="sp-nav">
        ...
        <button className="sp-nav-item" onClick={() => setCartOpen(true)}>
              ...
              cart.map((c, i) => (
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ color: 'var(--sp-blue)', fontSize: 12 }}>

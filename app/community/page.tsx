...
import {
    ArrowLeft, Search,
    Heart, MessageCircle, ExternalLink, Store,
    Send, X, ShoppingBag, Eye,
    Bookmark, BookmarkCheck, Clock, TrendingUp,
    Utensils, Shirt, Home, Smartphone, Dog, Sparkles, MoreHorizontal
} from 'lucide-react'
import {
    formatCOP,
...
type CategoryId = 'all' | 'moda' | 'hogar' | 'tecnologia' | 'mascotas' | 'alimentos' | 'belleza' | 'otros'
...
const t = (h: number, m: number) => new Date(today.getFullYear(), today.getMonth(), today.getDate(), h, m)

const DEMO_POSTS: CommunityPost[] = [
    {
        id: 'p1',
        owner: { id: 'o1', storeName: 'SneakerVault', storeColor: '#6c5ce7', storeUrl: '/store/calzado' },
        category: 'moda',
        productName: 'Air Jordan 1 Retro High OG',
        productImage: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600',
        price: 459000, originalPrice: 689000, discount: 33,
        description: '🔥 Recién llegadas! Edición limitada. Disponibles en todas las tallas del 38 al 44. Envío gratis por compras superiores a $200,000 🚚',
        likes: 127, liked: false, saved: false,
        views: 1523, storeClicks: 89,
        comments: [
            { id: 'c1', userId: 'u1', userName: 'Carlos M.', userColor: '#e17055', content: 'Esas Jordan están increíbles 🔥🔥 ¿tienen talla 42?', timestamp: t(10, 8) },
            { id: 'c2', userId: 'o1', userName: 'SneakerVault', userColor: '#6c5ce7', content: '¡Sí Carlos! Tenemos todas las tallas. Envío gratis 🚚', timestamp: t(10, 9), isOwner: true },
        ],
        timestamp: t(10, 5),
    },
    {
        ...
        price: 69000, originalPrice: 125000, discount: 45,
        description: '👑 Nueva colección! Solo por este fin de semana. Edición limitada con bordado dorado premium.',
        likes: 84, liked: true, saved: false,
        views: 967, storeClicks: 52,
        comments: [
            { id: 'c5', userId: 'u3', userName: 'Diego Torres', userColor: '#00cec9', content: '¡Esa gorra está brutal! La quiero 🔥', timestamp: t(10, 38) },
        ],
        timestamp: t(10, 35),
    },
    {
        id: 'p3',
        owner: { id: 'o3', storeName: 'Beauty Glow', storeColor: '#ff69b4', storeUrl: '/store/belleza' },
        category: 'belleza',
        ...
        price: 89000, originalPrice: 178000, discount: 50,
        description: '💄 ¡OFERTA FLASH! 50% de descuento en toda la línea de skincare. Solo hoy! 🌸\n\nUsa el código: BEAUTY50',
        likes: 215, liked: false, saved: true,
        views: 2341, storeClicks: 156,
        comments: [
            { id: 'c7', userId: 'u5', userName: 'Valentina R.', userColor: '#a29bfe', content: 'Wow estos productos se ven increíbles 😍 ¿Alguien los ha probado?', timestamp: t(10, 48) },
        ],
        timestamp: t(10, 45),
    },
    {
        id: 'p4',
        owner: { id: 'o4', storeName: 'TechZone', storeColor: '#0984e3', storeUrl: '/store/tecnologia' },
        category: 'tecnologia',
        ...
        price: 189000, originalPrice: 250000, discount: 24,
        description: '🎧 Sumérgete en tu música con la mejor cancelación de ruido activa. Batería de 24 horas y carga rápida.',
        likes: 156, liked: false, saved: true,
        views: 890, storeClicks: 67,
        comments: [],
        timestamp: t(9, 30),
    },
    {
        ...
        price: 120000, originalPrice: 160000, discount: 25,
        description: '🐶 El descanso que tu peludo merece. Espuma viscoelástica y funda lavable. Ideal para perros mayores o con problemas articulares.',
        likes: 92, liked: true, saved: false,
        views: 450, storeClicks: 30,
        comments: [
            { id: 'c9', userId: 'u8', userName: 'Ana P.', userColor: '#e17055', content: '¿Tienen para gatos también?', timestamp: t(11, 20) },
        ],
        timestamp: t(8, 15),
    },
    {
        id: 'p6',
        owner: { id: 'o6', storeName: 'Delicias Caseras', storeColor: '#e17055', storeUrl: '/store/alimentos' },
        category: 'alimentos',
        productName: 'Pack de Mermeladas Artesanales',
        productImage: 'https://images.unsplash.com/photo-1599321955726-e04842d994e7?w=600',
        price: 25000, originalPrice: 30000, discount: 16,
        description: '🍓 Hechas con fruta 100% natural, sin conservantes. Sabores: Fresa, Mora y Piña. ¡Perfectas para el desayuno!',
        likes: 45, liked: false, saved: false,
        views: 210, storeClicks: 15,
        comments: [],
        timestamp: t(8, 0),
    },
]
...
export default function CommunityPage() {
    ...
    const handleCommentKeyDown = useCallback((e: React.KeyboardEvent, postId: string) => {
        if (e.key === 'Enter') {
            e.preventDefault()
    ...
    return (
        <div className="cm-app">
            ...
            <div className="cm-header">
                <Link href="/" className="cm-header-back">
                    <ArrowLeft size={22} />
                </Link>
                ...
                <div className="cm-header-info">
                    <div className="cm-header-name">
                        Comunidad
                        {activeCategory !== 'all' && <span className="cm-header-cat-badge">• {CATEGORIES.find(c => c.id === activeCategory)?.label}</span>}
                    </div>
                </div>
                ...
                <div className="cm-header-actions">
                    <button
                        ...
                        onClick={() => {
                            ...
                            if (!showSearch) setTimeout(() => document.getElementById('cm-search-input')?.focus(), 100)
                        }}
                    >
                        <Search size={22} />
                    </button>
            ...
            <div className="cm-feed-status-bar">
                <span>
                    {searchQuery ? (
                        ...
                        <>{activeCategory === 'all' ? 'Explorar todo' : CATEGORIES.find(c => c.id === activeCategory)?.label}</>
                    )}
                </span>
                ...
                {filteredPosts.map(post => (
                    <article key={post.id} className="cm-post">
                        ...
                        <div className="cm-post-header">
                            ...
                            <div className="cm-post-store-info">
                                <div className="cm-post-store-name">
                                    ...
                                    <span className="cm-badge-cat">{CATEGORIES.find(c => c.id === post.category)?.label}</span>
                                </div>
                        ...
                        >
                            ...
                            {post.discount > 0 && (
                                <span className="cm-post-discount">-{post.discount}%</span>
                            )}
                        </Link>
                            ...
                            <div className="cm-comments-section">
                                <div className="cm-comments-list">
                                    ...
                                    {post.comments.map(comment => (
                                        <div key={comment.id} className={`cm-comment ${comment.isOwner ? 'is-owner' : ''}`}>

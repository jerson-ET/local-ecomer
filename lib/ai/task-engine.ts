    ...
    'create-product': {
        ...
        steps: {
            ...
            'description-mode': {
                ...
                options: ['Escribir manual', 'Generar con IA (Vendedor Experto)', 'Generar con IA (Divertido)'],
            ...
            'success': {
                id: 'success',
                type: 'DISPLAY',
                message: '¡Excelente! Tu producto ha sido publicado exitosamente. Puedes verlo en tu tienda.',
                next: () => null
            }
        }
    },
    'organize-store': {
        ...
        steps: {
            ...
            'audit-result': {
                id: 'audit-result',
                type: 'CHOICE',
                message: 'He notado que te faltan algunos elementos clave para vender más. ¿Por dónde empezamos?',
                options: ['Subir Logo/Banner', 'Crear Categorías', 'Configurar Horarios', 'Política de Envíos'],
                next: (choice) => {
            ...
            'create-categories': {
                ...
                type: 'TEXT_INPUT',
                message: 'Escribe los nombres de las categorías separados por comas (ej: Camisas, Pantalones):',
                next: () => 'success-update'
            },
            'info-config': {
                id: 'info-config',
